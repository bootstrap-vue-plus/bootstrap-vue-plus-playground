...
const toggleNightly = () => {
  ...
  setVersion('bootstrapVuePlus', 'latest')
}
...
<template>
  <nav>
    <h1>
      ...
      <span lt-sm-hidden>
        <span>Bootstrap Vue Plus Playground</span>
    ...
    <div flex="~ gap-2" items-center>
      ...
      <div flex="~ gap-4">
        ...
        />
        <a
          href="https://github.com/bootstrap-vue-plus/bootstrap-vue-plus-playground"
          target="_blank"
        >
